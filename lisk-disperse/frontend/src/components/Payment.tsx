...
const Payment = ({ address }: PaymentProps) => {
  ...
  const [tokenAddress, setTokenAddress] = useState("0x8a21CF9Ba08Ae709D64Cb25AfAA951183EC9FF6D");
  ...
  const getLiskBalance = async (ethereum: any) => {
    if (!liskBalance) {
        ...
        <div className="mt-12 mb-24">
          ...
          <div className="flex mt-6">
            <input
              ...
              placeholder="0x8a21CF9Ba08Ae709D64Cb25AfAA951183EC9FF6D"
              value={tokenAddress}
